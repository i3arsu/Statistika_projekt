...
def create_geojson_features(df):
    ...
    s = max(df['total_cases']/df['population'])**0.5 # biggest data value to color
    ...
    for _, row in df.iterrows():
        ...
        gb = 255-int((255*(((row['total_cases']/row['population'])**0.5)/s))) # map data to a color (shade of red)
...
folium_map.save("Timelapse_covid19.html")
